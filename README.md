...
* uploading the ontology to the KB can now be disabled. This can be useful if the ontology is uploaded in a different way or is already in the KB. See the [doc](https://github.com/deib-polimi/modaclouds-monitoring-manager/blob/master/doc/user-manual.md#usage)
